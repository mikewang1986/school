...
?> 
		...
		<?php		
				...
				?>
				<li><a href="http://www.xuer.com/<?= $val['classurl']?>"><?= $val['classname']?></a></li>
<?php			}
			}
		}
?>
...
$(function(){
    ...
    <div class="denglu" id="alert">
        ...
        <div class="zhuce_left">
            ...
            <p>密码<span class="xian">|</span><span class="english">password</span><span class="xing">*</span></p>
            <input type="password" name="password" id="password" class="pwd" placeholder="请输入密码" onkeypress="if(event.keyCode==13) {$('#log').click();}"/>
