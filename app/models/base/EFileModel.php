...
abstract class EFileModel extends EActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            [['file_size, display_order', 'numerical'], 'integerOnly' => true],
            [['uid'], 'length', 'is' => 32],
            [['file_name, thumbnail_name'], 'length', 'max' => 40],
            [['file_ext'], 'length', 'max' => 10],
            [['mime_type'], 'length', 'max' => 20],
            [['file_url, thumbnail_url, base_url'], 'length', 'max' => 255],
    ...
    public function setFileAttributes($file) {
        ...
        $this->setBaseUrl(Yii::$app->urlManager->getBaseUrl(true));
    }
    ...
    public function getRootUrl() {
        if (isset($this->base_url) && ($this->base_url != '')) {
            ...
            return Yii::$app->urlManager->getBaseUrl(true);
        }
    }
